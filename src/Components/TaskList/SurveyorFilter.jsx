...
export default function SurveyorFilter({ setSelectedID, setType,
    ...
    const { selectedSurveyors, setSelectedSurveyors } = useContext(PageContext);
    ...
    const handleWithoutAllselect = (id) => {
        ...
        if (selectedUsers.includes(id)) {
            ...
            setSurveyorId(selectedUsers.filter((i) => i !== id));
            setSelectedSurveyors(selectedUsers.filter((i) => i !== id));
        } else {
            // setActiveSelectedSurveyors(true);
            setSelectedUsers([...selectedUsers, id]);
            setSurveyorId([...selectedUsers, id]);
            setSelectedSurveyors([...selectedUsers, id]);
        }
    };
